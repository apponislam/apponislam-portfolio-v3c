        ...
        <div className="space-y-16">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              I specialize in a wide range of modern web technologies, from frontend frameworks to backend systems and infrastructure.
            </p>
          </div>
          ...
          <div className="skills-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8">
            {skills.map((skill, index) => {
              ...
              return (
                <div
                  key={index}
                  className="skill-item group p-6 rounded-2xl bg-secondary/30 hover:bg-primary transition-all duration-300 flex flex-col items-center gap-4 text-center cursor-default border border-border/50 hover:scale-105"
                >
                  ...
                  <span className="text-sm font-bold text-muted-foreground group-hover:text-primary-foreground transition-colors">
                    {skill}
                  </span>
                </div>
              );
