        ...
        <div className="space-y-16">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Exploring the frontiers of web development, sharing insights, and documenting my journey through code.
            </p>
          </div>
          ...
          <div className="blog-grid grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {blogs.map((blog) => (
              <div
                key={blog.id}
                className="blog-card group relative bg-secondary/20 rounded-3xl overflow-hidden border border-border/50 hover:shadow-2xl transition-all duration-500 flex flex-col"
              >
          ...
          <div className="text-center pt-8">
            <button className="px-8 py-4 bg-secondary text-secondary-foreground rounded-full font-semibold border border-border/50 hover:bg-secondary/80 transition-all">
              View All Articles
            </button>
          </div>
        </div>
