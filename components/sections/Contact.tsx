            ...
            <div className="container-wide">
                <div className="space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">Have a project in mind? Let&apos;s build something amazing together. Reach out and I&apos;ll get back to you as soon as possible.</p>
                    </div>

                    <div className="contact-grid grid grid-cols-1 lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
                        {/* Contact Info */}
                        <div className="space-y-8">
                            <div className="contact-item group relative p-8 rounded-4xl glass hover:border-primary/50 transition-all duration-500 overflow-hidden">
                                ...
                                <div className="relative flex items-center gap-6">
                                    <div className="shrink-0 w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500 shadow-inner">
                        ...
                        <div className="contact-form bg-secondary/20 border border-border/50 rounded-[40px] p-8 md:p-12 shadow-2xl relative">
                            {isSuccess && (
                                <div className="absolute inset-0 bg-background/90 backdrop-blur-sm z-10 rounded-[40px] flex flex-col items-center justify-center p-8 text-center space-y-4">
                                    ...
                                    <button onClick={() => setIsSuccess(false)} className="text-primary font-bold hover:underline pt-4">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <input {...register("name")} className={cn("w-full bg-background border border-border/50 rounded-2xl p-4 focus:ring-2 focus:ring-primary outline-none transition-all", errors.name && "border-destructive focus:ring-destructive")} placeholder="John Doe" />
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <input {...register("email")} className={cn("w-full bg-background border border-border/50 rounded-2xl p-4 focus:ring-2 focus:ring-primary outline-none transition-all", errors.email && "border-destructive focus:ring-destructive")} placeholder="john@example.com" />
                                ...
                                <div className="space-y-3">
                                    ...
                                    <input {...register("subject")} className={cn("w-full bg-background border border-border/50 rounded-2xl p-4 focus:ring-2 focus:ring-primary outline-none transition-all", errors.subject && "border-destructive focus:ring-destructive")} placeholder="Project Inquiry" />
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea {...register("message")} rows={6} className={cn("w-full bg-background border border-border/50 rounded-2xl p-4 focus:ring-2 focus:ring-primary outline-none transition-all resize-none", errors.message && "border-destructive focus:ring-destructive")} placeholder="Tell me about your project..." />
                                    {errors.message && <p className="text-xs font-medium text-destructive">{errors.message.message}</p>}
                                </div>

                                <button type="submit" disabled={isSubmitting} className={cn("w-full py-5 bg-primary text-primary-foreground rounded-2xl font-bold text-lg transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 overflow-hidden group", isSubmitting && "opacity-70 cursor-not-allowed")}>
                                    {isSubmitting ? (
